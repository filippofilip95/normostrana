const translations = {
    sk: {
        ...
        standardPageInfo1:
            'Normostrana znamená normovaná, alebo štandardizovaná strana s rozsahom ',
        standardPageInfo2:
            'znakov (vrátane medzier) a používa sa na meranie rozsahu textu. Koeficient je definovaný v norme ',
        standardPageShortName: 'NS',
        standardPageUsage1: 'Normostrana sa niekedy označuje aj ako ',
        standardPageUsage2:
            'a používa sa v publicistike, prekladatelstve, a copywritingu. Taktiež sa s nou môžeme stretnúť pri školských prácach, univezitných závarečných prácach a referátoch',
    ...
    cs: {
        ...
        thesisRangeCaption:
            'Uvedené rozsahy jsou podle směrnice Univerzity UKF v Nitře. Na jiných univerzitách se mohou lišit',
        license: '',
        language: 'Jazyk:',
    },
}
